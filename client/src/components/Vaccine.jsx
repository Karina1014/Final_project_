...
const Vaccine = () => {
  ...
  const obtenerVacunas = async () => {
    try {
      const response = await axios.get("http://52.90.188.51:3002/api/vaccines", { withCredentials: true });
  ...
  // Insertar vacuna
   ...
   const insertar = async () => {
    try {
      await axios.post("http://52.90.188.51:3001/api/createVaccines", form, { withCredentials: true });
      obtenerVacunas();
      cerrarModalInsertar();
  ...
  try {
    ...
    const response = await axios.put(
      "http://52.90.188.51:3004/api/updateVaccines", 
      formData, 
...
const eliminar = async (id_vaccine) => {
  try {
    ...
    const response = await axios.delete(`http://52.90.188.51:3003/api/deleteVaccine/${id_vaccine}`, { withCredentials: true });
